...
perfSONAR_PS::NPToolkit::Config::LSRegistrationDaemon

=head1 DESCRIPTION

Module for reading/writing commonly configured aspects of the LS Registration
Daemon. Currently, the external address, site location and site name are
configurable.

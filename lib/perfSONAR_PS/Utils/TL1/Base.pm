...
=head2 login()
Internal function used to login to the service. MUST be overridden by implementing classes.
=cut
sub login {
...
=head2 logout()
Internal function used to logout of the service. CAN be overridden by implementing class if more is required than just disconnecting from the machine.
=cut
sub logout {
    return;
}
...
L<POSIX>,L<Net::Telnet>,L<Log::Log4perl>,L<perfSONAR_PS::Utils::ParameterValidation>

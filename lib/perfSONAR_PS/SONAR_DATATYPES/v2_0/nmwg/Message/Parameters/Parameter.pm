package  perfSONAR_PS::SONAR_DATATYPES::v2_0::nmwg::Message::Parameters::Parameter;
...
perfSONAR_PS::SONAR_DATATYPES::v2_0::nmwg::Message::Parameters::Parameter  -  this is data binding class for  'parameter'  element from the XML schema namespace nmwg
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::SONAR_DATATYPES::v2_0::nmwg::Message::Parameters::Parameter->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::SONAR_DATATYPES::v2_0::nmwg::Message::Parameters::Parameter->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::SONAR_DATATYPES::v2_0::nmwg::Message::Parameters::Parameter';

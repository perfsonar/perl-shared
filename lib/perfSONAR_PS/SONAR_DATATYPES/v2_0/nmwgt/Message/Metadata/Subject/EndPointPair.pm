package  perfSONAR_PS::SONAR_DATATYPES::v2_0::nmwgt::Message::Metadata::Subject::EndPointPair;
...
perfSONAR_PS::SONAR_DATATYPES::v2_0::nmwgt::Message::Metadata::Subject::EndPointPair  -  this is data binding class for  'endPointPair'  element from the XML schema namespace nmwgt
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::SONAR_DATATYPES::v2_0::nmwgt::Message::Metadata::Subject::EndPointPair->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::SONAR_DATATYPES::v2_0::nmwgt::Message::Metadata::Subject::EndPointPair->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::SONAR_DATATYPES::v2_0::nmwgt::Message::Metadata::Subject::EndPointPair';
...
sub fromDOM {
	...
	my $element;
        ...
        if ($tagname eq  'src' && $nsid eq 'nmwgt' && $self->can("get_$tagname")) {
                eval {
                    $element = perfSONAR_PS::SONAR_DATATYPES::v2_0::nmwgt::Message::Metadata::Subject::EndPointPair::Src->new($childnode)
                };
              ...
              $self->set_src($element); ### add another src  
                ...
                eval {
                    $element = perfSONAR_PS::SONAR_DATATYPES::v2_0::nmwgt::Message::Metadata::Subject::EndPointPair::Dst->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {

package  perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtm::Message::Data::Datum::Time;
...
perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtm::Message::Data::Datum::Time  -  this is data binding class for  'time'  element from the XML schema namespace nmtm
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtm::Message::Data::Datum::Time->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtm::Message::Data::Datum::Time->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtm::Message::Data::Datum::Time';

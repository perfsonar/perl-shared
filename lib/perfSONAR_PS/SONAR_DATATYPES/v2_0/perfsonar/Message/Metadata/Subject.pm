...
sub addEndPointPair {
    ...
    $self->get_endPointPair && ref($self->get_endPointPair) eq 'ARRAY'?push @{$self->get_endPointPair}, $new:
                                                                 $self->set_endPointPair([$new]);
...
sub removeEndPointPairById {
    my ($self, $id) = @_;
    if(ref($self->get_endPointPair) eq 'ARRAY' && $self->get_idmap->{endPointPair} &&  
       exists $self->get_idmap->{endPointPair}{$id}) {

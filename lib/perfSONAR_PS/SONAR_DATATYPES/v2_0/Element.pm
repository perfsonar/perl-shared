package perfSONAR_PS::SONAR_DATATYPES::v2_0::Element;
use strict;
use warnings;
...
perfSONAR_PS::SONAR_DATATYPES::v2_0::Element -  static class for basic element manipulations
...
use Data::Dumper;
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::SONAR_DATATYPES::v2_0::Element';
Readonly::Hash   our %NSREGISTRY => ( 'nmtl2' => 'http://ogf.org/schema/network/topology/l2/20070707/',

package  perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Metadata::Subject;
...
perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Metadata::Subject  -  this is data binding class for  'subject'  element from the XML schema namespace pinger

=head1 DESCRIPTION

Object representation of the subject element of the pinger XML namespace.
Object fields are:
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Metadata::Subject->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Metadata::Subject->new({xml => $xml_string});
...
use fields qw(nsmap idmap LOGGER metadataIdRef id endPointPair );
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Metadata::Subject';
...
sub getDOM {
    ...
    if($self->get_endPointPair && blessed $self->get_endPointPair && $self->get_endPointPair->can("getDOM")) {
...
sub fromDOM {
	...
	my $element;
        ...
        if ($tagname eq  'endPointPair' && $nsid eq 'nmwgt' && $self->can("get_$tagname")) {
                eval {
        ...
        elsif ($tagname eq  'endPointPair' && $nsid eq 'nmtl4' && $self->can("get_$tagname")) {
                eval {

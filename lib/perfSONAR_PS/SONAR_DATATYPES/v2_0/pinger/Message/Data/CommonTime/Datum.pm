package  perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum;
...
perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum  -  this is data binding class for  'datum'  element from the XML schema namespace pinger
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum';
...
sub  querySQL {
    my ($self, $query) = @_;
     ...
     $query->{data}{numBytes}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{numBytes}) || ref($query->{data}{numBytes});
     $query->{data}{ttl}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{ttl}) || ref($query->{data}{ttl});
     $query->{data}{minRtt}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{minRtt}) || ref($query->{data}{minRtt});
     $query->{data}{maxRtt}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{maxRtt}) || ref($query->{data}{maxRtt});
     $query->{data}{outOfOrder}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{outOfOrder}) || ref($query->{data}{outOfOrder});
     $query->{data}{medianRtt}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{medianRtt}) || ref($query->{data}{medianRtt});
     $query->{data}{clp}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{clp}) || ref($query->{data}{clp});
     $query->{data}{meanRtt}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{meanRtt}) || ref($query->{data}{meanRtt});
     $query->{data}{duplicates}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{duplicates}) || ref($query->{data}{duplicates});
     $query->{data}{maxIpd}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{maxIpd}) || ref($query->{data}{maxIpd});
     $query->{data}{minIpd}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{minIpd}) || ref($query->{data}{minIpd});
     $query->{data}{meanIpd}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{meanIpd}) || ref($query->{data}{meanIpd});
     $query->{data}{iqrIpd}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{iqrIpd}) || ref($query->{data}{iqrIpd});
     $query->{data}{lossPercent}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{lossPercent}) || ref($query->{data}{lossPercent});
     $query->{data}{minRtt}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{minRtt}) || ref($query->{data}{minRtt});
     $query->{data}{maxRtt}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{maxRtt}) || ref($query->{data}{maxRtt});
     $query->{data}{outOfOrder}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{outOfOrder}) || ref($query->{data}{outOfOrder});
     $query->{data}{rtts}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{rtts}) || ref($query->{data}{rtts});
     $query->{data}{medianRtt}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{medianRtt}) || ref($query->{data}{medianRtt});
     $query->{data}{clp}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{clp}) || ref($query->{data}{clp});
     $query->{data}{meanRtt}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{meanRtt}) || ref($query->{data}{meanRtt});
     $query->{data}{maxIpd}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{maxIpd}) || ref($query->{data}{maxIpd});
     ...
     $query->{data}{iqrIpd}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{iqrIpd}) || ref($query->{data}{iqrIpd});
     $query->{data}{lossPercent}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{lossPercent}) || ref($query->{data}{lossPercent});
     $query->{data}{seqNums}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum' ] if!(defined $query->{data}{seqNums}) || ref($query->{data}{seqNums});
            ...
            foreach my $entry (@{$defined_table{$table}}) {
                if(ref($query->{$table}{$entry}) eq 'ARRAY') {
                    foreach my $classes (@{$query->{$table}{$entry}}) {
                         if($classes && $classes eq 'perfSONAR_PS::SONAR_DATATYPES::v2_0::pinger::Message::Data::CommonTime::Datum') {

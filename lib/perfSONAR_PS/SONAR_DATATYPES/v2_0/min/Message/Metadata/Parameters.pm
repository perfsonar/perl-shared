package  perfSONAR_PS::SONAR_DATATYPES::v2_0::min::Message::Metadata::Parameters;
...
perfSONAR_PS::SONAR_DATATYPES::v2_0::min::Message::Metadata::Parameters  -  this is data binding class for  'parameters'  element from the XML schema namespace min

=head1 DESCRIPTION

Object representation of the parameters element of the min XML namespace.
Object fields are:
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::SONAR_DATATYPES::v2_0::min::Message::Metadata::Parameters->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::SONAR_DATATYPES::v2_0::min::Message::Metadata::Parameters->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::SONAR_DATATYPES::v2_0::min::Message::Metadata::Parameters';
...
sub new {
    ...
    $self->get_nsmap->mapname($LOCALNAME, 'min');

package  perfSONAR_PS::SONAR_DATATYPES::v2_0::select::Message::Metadata::Subject;
...
perfSONAR_PS::SONAR_DATATYPES::v2_0::select::Message::Metadata::Subject  -  this is data binding class for  'subject'  element from the XML schema namespace select
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::SONAR_DATATYPES::v2_0::select::Message::Metadata::Subject->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::SONAR_DATATYPES::v2_0::select::Message::Metadata::Subject->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::SONAR_DATATYPES::v2_0::select::Message::Metadata::Subject';

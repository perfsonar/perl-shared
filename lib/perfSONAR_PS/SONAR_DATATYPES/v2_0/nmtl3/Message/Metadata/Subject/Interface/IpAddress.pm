package  perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::Interface::IpAddress;
...
perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::Interface::IpAddress  -  this is data binding class for  'ipAddress'  element from the XML schema namespace nmtl3
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::Interface::IpAddress->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::Interface::IpAddress->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::Interface::IpAddress';
...
sub  querySQL {
    my ($self, $query) = @_;
     ...
     $query->{host}{ip_number}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::Interface::IpAddress' ] if!(defined $query->{host}{ip_number}) || ref($query->{host}{ip_number});
     $query->{host}{ip_number}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::Interface::IpAddress' ] if!(defined $query->{host}{ip_number}) || ref($query->{host}{ip_number});
     $query->{metaData}{transport}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::Interface::IpAddress' ] if!(defined $query->{metaData}{transport}) || ref($query->{metaData}{transport});
            ...
            foreach my $entry (@{$defined_table{$table}}) {
                if(ref($query->{$table}{$entry}) eq 'ARRAY') {
                    foreach my $classes (@{$query->{$table}{$entry}}) {
                         if($classes && $classes eq 'perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::Interface::IpAddress') {

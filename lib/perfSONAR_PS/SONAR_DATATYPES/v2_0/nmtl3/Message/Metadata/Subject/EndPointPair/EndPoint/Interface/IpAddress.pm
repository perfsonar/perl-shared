package  perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress;
...
perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress  -  this is data binding class for  'ipAddress'  element from the XML schema namespace nmtl3

=head1 DESCRIPTION

Object representation of the ipAddress element of the nmtl3 XML namespace.
Object fields are:
...
The constructor accepts only single parameter, it could be a hashref with keyd  parameters hash  or DOM of the  'ipAddress' element
...
=head1 SYNOPSIS
          ...
          use perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress;
          use Log::Log4perl qw(:easy);

          Log::Log4perl->easy_init();

          my $el =  perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress';
...
sub getDOM {
    ...
    eval { 
        ...
        $ipAddress = getElement({name =>   $LOCALNAME, 
	                      parent => $parent,
			      ns  =>    \@nss,
                              attributes => [
...
sub  querySQL {
    my ($self, $query) = @_;
     ...
     $query->{host}{ip_number}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress' ] if!(defined $query->{host}{ip_number}) || ref($query->{host}{ip_number});
     $query->{host}{ip_number}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress' ] if!(defined $query->{host}{ip_number}) || ref($query->{host}{ip_number});
     $query->{metaData}{transport}= [ 'perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress' ] if!(defined $query->{metaData}{transport}) || ref($query->{metaData}{transport});
            ...
            foreach my $entry (@{$defined_table{$table}}) {
                if(ref($query->{$table}{$entry}) eq 'ARRAY') {
                    foreach my $classes (@{$query->{$table}{$entry}}) {
                         if($classes && $classes eq 'perfSONAR_PS::SONAR_DATATYPES::v2_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress') {
...
=head2  asString()
 ...
 returns nicely formatted XML string  representation of the  ipAddress object

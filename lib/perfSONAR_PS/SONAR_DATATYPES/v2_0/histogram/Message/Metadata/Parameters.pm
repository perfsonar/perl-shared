package  perfSONAR_PS::SONAR_DATATYPES::v2_0::histogram::Message::Metadata::Parameters;
...
perfSONAR_PS::SONAR_DATATYPES::v2_0::histogram::Message::Metadata::Parameters  -  this is data binding class for  'parameters'  element from the XML schema namespace histogram
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::SONAR_DATATYPES::v2_0::histogram::Message::Metadata::Parameters->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::SONAR_DATATYPES::v2_0::histogram::Message::Metadata::Parameters->new({xml => $xml_string});
...
use perfSONAR_PS::SONAR_DATATYPES::v2_0::nmwg::Message::Metadata::Parameters::Parameter;
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::SONAR_DATATYPES::v2_0::histogram::Message::Metadata::Parameters';
...
sub fromDOM {
	...
	my $element;
        ...
        if ($tagname eq  'parameter' && $nsid eq 'nmwg' && $self->can("get_$tagname")) {
                eval {
                    $element = perfSONAR_PS::SONAR_DATATYPES::v2_0::nmwg::Message::Metadata::Parameters::Parameter->new($childnode)
                };

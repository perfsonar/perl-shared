package  perfSONAR_PS::PINGERTOPO_DATATYPES::v2_0::nmtb::Topology::Domain::Comments;
...
perfSONAR_PS::PINGERTOPO_DATATYPES::v2_0::nmtb::Topology::Domain::Comments  -  this is data binding class for  'comments'  element from the XML schema namespace nmtb

=head1 DESCRIPTION

Object representation of the comments element of the nmtb XML namespace.
Object fields are:




The constructor accepts only single parameter, it could be a hashref with keyd  parameters hash  or DOM of the  'comments' element
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::PINGERTOPO_DATATYPES::v2_0::nmtb::Topology::Domain::Comments->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::PINGERTOPO_DATATYPES::v2_0::nmtb::Topology::Domain::Comments->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::PINGERTOPO_DATATYPES::v2_0::nmtb::Topology::Domain::Comments';
Readonly::Scalar our $LOCALNAME => 'comments';
...
sub getDOM {
    ...
    eval { 
        ...
        $comments = getElement({name =>   $LOCALNAME, 
	                      parent => $parent,
			      ns  =>    \@nss,
                              attributes => [
...
=head2  asString()
 ...
 returns nicely formatted XML string  representation of the  comments object

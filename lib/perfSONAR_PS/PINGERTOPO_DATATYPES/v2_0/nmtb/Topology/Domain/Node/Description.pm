package  perfSONAR_PS::PINGERTOPO_DATATYPES::v2_0::nmtb::Topology::Domain::Node::Description;
...
perfSONAR_PS::PINGERTOPO_DATATYPES::v2_0::nmtb::Topology::Domain::Node::Description  -  this is data binding class for  'description'  element from the XML schema namespace nmtb

=head1 DESCRIPTION

Object representation of the description element of the nmtb XML namespace.
Object fields are:




The constructor accepts only single parameter, it could be a hashref with keyd  parameters hash  or DOM of the  'description' element
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::PINGERTOPO_DATATYPES::v2_0::nmtb::Topology::Domain::Node::Description->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::PINGERTOPO_DATATYPES::v2_0::nmtb::Topology::Domain::Node::Description->new({xml => $xml_string});
...
use fields qw(nsmap idmap LOGGER    text );
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::PINGERTOPO_DATATYPES::v2_0::nmtb::Topology::Domain::Node::Description';
Readonly::Scalar our $LOCALNAME => 'description';
...
=head2   getDOM ($parent)
 ...
 returns description object DOM
...
sub getDOM {
    ...
    eval { 
        ...
        $description = getElement({name =>   $LOCALNAME, 
	                      parent => $parent,
			      ns  =>    \@nss,
                              attributes => [
...
=head2  asString()
 ...
 returns nicely formatted XML string  representation of the  description object

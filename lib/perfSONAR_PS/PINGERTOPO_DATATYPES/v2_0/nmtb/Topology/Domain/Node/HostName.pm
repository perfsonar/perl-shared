package  perfSONAR_PS::PINGERTOPO_DATATYPES::v2_0::nmtb::Topology::Domain::Node::HostName;
...
perfSONAR_PS::PINGERTOPO_DATATYPES::v2_0::nmtb::Topology::Domain::Node::HostName  -  this is data binding class for  'hostName'  element from the XML schema namespace nmtb

=head1 DESCRIPTION

Object representation of the hostName element of the nmtb XML namespace.
Object fields are:




The constructor accepts only single parameter, it could be a hashref with keyd  parameters hash  or DOM of the  'hostName' element
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::PINGERTOPO_DATATYPES::v2_0::nmtb::Topology::Domain::Node::HostName->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::PINGERTOPO_DATATYPES::v2_0::nmtb::Topology::Domain::Node::HostName->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::PINGERTOPO_DATATYPES::v2_0::nmtb::Topology::Domain::Node::HostName';
Readonly::Scalar our $LOCALNAME => 'hostName';
...
sub getDOM {
    ...
    eval { 
        ...
        $hostName = getElement({name =>   $LOCALNAME, 
	                      parent => $parent,
			      ns  =>    \@nss,
                              attributes => [
...
=head2  asString()
 ...
 returns nicely formatted XML string  representation of the  hostName object

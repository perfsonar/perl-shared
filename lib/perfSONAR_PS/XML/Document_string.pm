...
perfSONAR_PS::XML::Document_string

=head1 DESCRIPTION

This module is used to provide a more abstract method for constructing XML
documents that can be implemented using string construction, outputting to a
file or even DOM construction without tying the code creating the XML to any

package  perfSONAR_PS::PINGER_DATATYPES::v2_0::min::Message::Parameters;
...
perfSONAR_PS::PINGER_DATATYPES::v2_0::min::Message::Parameters  -  this is data binding class for  'parameters'  element from the XML schema namespace min
...
=head1 SYNOPSIS
          ...
          use perfSONAR_PS::PINGER_DATATYPES::v2_0::min::Message::Parameters;
          use Log::Log4perl qw(:easy);

          Log::Log4perl->easy_init();

          my $el =  perfSONAR_PS::PINGER_DATATYPES::v2_0::min::Message::Parameters->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::PINGER_DATATYPES::v2_0::min::Message::Parameters->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::PINGER_DATATYPES::v2_0::min::Message::Parameters';

package  perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwgr::Message::Data::CommonTime::Datum;
...
perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwgr::Message::Data::CommonTime::Datum  -  this is data binding class for  'datum'  element from the XML schema namespace nmwgr

=head1 DESCRIPTION

Object representation of the datum element of the nmwgr XML namespace.
Object fields are:
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwgr::Message::Data::CommonTime::Datum->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwgr::Message::Data::CommonTime::Datum->new({xml => $xml_string});
...
use fields qw(nsmap idmap LOGGER type   text );
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwgr::Message::Data::CommonTime::Datum';
...
sub new {
    ...
    $self->get_nsmap->mapname($LOCALNAME, 'nmwgr');

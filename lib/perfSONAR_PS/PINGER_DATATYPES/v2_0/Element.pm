package perfSONAR_PS::PINGER_DATATYPES::v2_0::Element;
use strict;
use warnings;
...
perfSONAR_PS::PINGER_DATATYPES::v2_0::Element -  static class for basic element manipulations
...
use Data::Dumper;
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::PINGER_DATATYPES::v2_0::Element';

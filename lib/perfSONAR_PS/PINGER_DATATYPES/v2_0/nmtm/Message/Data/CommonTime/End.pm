package  perfSONAR_PS::PINGER_DATATYPES::v2_0::nmtm::Message::Data::CommonTime::End;
...
perfSONAR_PS::PINGER_DATATYPES::v2_0::nmtm::Message::Data::CommonTime::End  -  this is data binding class for  'end'  element from the XML schema namespace nmtm

=head1 DESCRIPTION

Object representation of the end element of the nmtm XML namespace.
Object fields are:
...
The constructor accepts only single parameter, it could be a hashref with keyd  parameters hash  or DOM of the  'end' element
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::PINGER_DATATYPES::v2_0::nmtm::Message::Data::CommonTime::End->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::PINGER_DATATYPES::v2_0::nmtm::Message::Data::CommonTime::End->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmtm::Message::Data::CommonTime::End';
Readonly::Scalar our $LOCALNAME => 'end';
...
=head2  asString()
 ...
 returns nicely formatted XML string  representation of the  end object

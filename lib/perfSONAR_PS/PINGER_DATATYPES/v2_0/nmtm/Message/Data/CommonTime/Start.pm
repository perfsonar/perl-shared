package  perfSONAR_PS::PINGER_DATATYPES::v2_0::nmtm::Message::Data::CommonTime::Start;
...
perfSONAR_PS::PINGER_DATATYPES::v2_0::nmtm::Message::Data::CommonTime::Start  -  this is data binding class for  'start'  element from the XML schema namespace nmtm

=head1 DESCRIPTION

Object representation of the start element of the nmtm XML namespace.
Object fields are:
...
The constructor accepts only single parameter, it could be a hashref with keyd  parameters hash  or DOM of the  'start' element
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::PINGER_DATATYPES::v2_0::nmtm::Message::Data::CommonTime::Start->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::PINGER_DATATYPES::v2_0::nmtm::Message::Data::CommonTime::Start->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmtm::Message::Data::CommonTime::Start';
...
sub getDOM {
    ...
    eval { 
        ...
        $start = getElement({name =>   $LOCALNAME, 
	                      parent => $parent,
			      ns  =>    \@nss,
                              attributes => [
...
=head2  asString()
 ...
 returns nicely formatted XML string  representation of the  start object

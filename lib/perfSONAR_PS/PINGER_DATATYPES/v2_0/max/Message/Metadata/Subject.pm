package  perfSONAR_PS::PINGER_DATATYPES::v2_0::max::Message::Metadata::Subject;
...
perfSONAR_PS::PINGER_DATATYPES::v2_0::max::Message::Metadata::Subject  -  this is data binding class for  'subject'  element from the XML schema namespace max

=head1 DESCRIPTION

Object representation of the subject element of the max XML namespace.
Object fields are:
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::PINGER_DATATYPES::v2_0::max::Message::Metadata::Subject->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::PINGER_DATATYPES::v2_0::max::Message::Metadata::Subject->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::PINGER_DATATYPES::v2_0::max::Message::Metadata::Subject';

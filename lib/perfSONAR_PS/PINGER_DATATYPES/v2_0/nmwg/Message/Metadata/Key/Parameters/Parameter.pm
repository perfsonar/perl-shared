package  perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter;
...
perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter  -  this is data binding class for  'parameter'  element from the XML schema namespace nmwg
...
=head1 SYNOPSIS
          ...
          use perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter;
          use Log::Log4perl qw(:easy);

          Log::Log4perl->easy_init();

          my $el =  perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter';
...
sub  querySQL {
    my ($self, $query) = @_;
     ...
     $query->{metaData}{protocol}= [ 'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{metaData}{protocol}) || ref($query->{metaData}{protocol});
     $query->{metaData}{count}= [ 'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{metaData}{count}) || ref($query->{metaData}{count});
     $query->{metaData}{transport}= [ 'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{metaData}{transport}) || ref($query->{metaData}{transport});
     $query->{metaData}{packetSize}= [ 'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{metaData}{packetSize}) || ref($query->{metaData}{packetSize});
     $query->{metaData}{project}= [ 'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{metaData}{project}) || ref($query->{metaData}{project});
     $query->{metaData}{ttl}= [ 'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{metaData}{ttl}) || ref($query->{metaData}{ttl});
     $query->{metaData}{packetInterval}= [ 'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{metaData}{packetInterval}) || ref($query->{metaData}{packetInterval});
     $query->{time}{resolution}= [ 'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{time}{resolution}) || ref($query->{time}{resolution});
     $query->{time}{cf}= [ 'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{time}{cf}) || ref($query->{time}{cf});
     $query->{time}{start}= [ 'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{time}{start}) || ref($query->{time}{start});
     $query->{time}{end}= [ 'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{time}{end}) || ref($query->{time}{end});
     $query->{limit}{setLimit}= [ 'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{limit}{setLimit}) || ref($query->{limit}{setLimit});
     $query->{metaData}{protocol}= [ 'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{metaData}{protocol}) || ref($query->{metaData}{protocol});
     $query->{metaData}{count}= [ 'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{metaData}{count}) || ref($query->{metaData}{count});
     $query->{metaData}{transport}= [ 'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{metaData}{transport}) || ref($query->{metaData}{transport});
     $query->{metaData}{packetSize}= [ 'perfSONAR_PS::PINGER_DATATYPES::v2_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{metaData}{packetSize}) || ref($query->{metaData}{packetSize});

...
package OSCARS::Type::createPathContent;


our @ISA=qw(XML::Pastor::ComplexType);

OSCARS::Type::createPathContent->mk_accessors( qw(token globalReservationId));

OSCARS::Type::createPathContent->XmlSchemaType( bless( {
                 'attributeInfo' => {},
                 'attributePrefix' => '_',
                 'attributes' => [],
                 'baseClasses' => [
...
B<OSCARS::Type::createPathContent>  -  A class generated by L<XML::Pastor> . 

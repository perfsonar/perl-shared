...
package OSCARS::Type::SignalFault;


our @ISA=qw(XML::Pastor::ComplexType);

OSCARS::Type::SignalFault->mk_accessors( qw(msg));

OSCARS::Type::SignalFault->XmlSchemaType( bless( {
                 'attributeInfo' => {},
                 'attributePrefix' => '_',
                 'attributes' => [],
                 'baseClasses' => [
...
B<OSCARS::Type::SignalFault>  -  A class generated by L<XML::Pastor> . 

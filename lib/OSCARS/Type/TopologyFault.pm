...
package OSCARS::Type::TopologyFault;


our @ISA=qw(XML::Pastor::ComplexType);

OSCARS::Type::TopologyFault->mk_accessors( qw(msg));

OSCARS::Type::TopologyFault->XmlSchemaType( bless( {
                 'attributeInfo' => {},
                 'attributePrefix' => '_',
                 'attributes' => [],
                 'baseClasses' => [
...
B<OSCARS::Type::TopologyFault>  -  A class generated by L<XML::Pastor> . 

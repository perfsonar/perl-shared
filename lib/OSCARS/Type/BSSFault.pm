...
package OSCARS::Type::BSSFault;


our @ISA=qw(XML::Pastor::ComplexType);

OSCARS::Type::BSSFault->mk_accessors( qw(msg));

OSCARS::Type::BSSFault->XmlSchemaType( bless( {
                 'attributeInfo' => {},
                 'attributePrefix' => '_',
                 'attributes' => [],
                 'baseClasses' => [
...
B<OSCARS::Type::BSSFault>  -  A class generated by L<XML::Pastor> . 

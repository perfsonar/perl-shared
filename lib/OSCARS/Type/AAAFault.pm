...
package OSCARS::Type::AAAFault;


our @ISA=qw(XML::Pastor::ComplexType);

OSCARS::Type::AAAFault->mk_accessors( qw(msg));

OSCARS::Type::AAAFault->XmlSchemaType( bless( {
                 'attributeInfo' => {},
                 'attributePrefix' => '_',
                 'attributes' => [],
                 'baseClasses' => [
...
B<OSCARS::Type::AAAFault>  -  A class generated by L<XML::Pastor> . 

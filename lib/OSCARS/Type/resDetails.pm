...
package OSCARS::Type::resDetails;

use OSCARS::Type::pathInfo;

our @ISA=qw(XML::Pastor::ComplexType);

OSCARS::Type::resDetails->mk_accessors( qw(globalReservationId login status startTime endTime createTime bandwidth description pathInfo));

OSCARS::Type::resDetails->XmlSchemaType( bless( {
                 'attributeInfo' => {},
                 'attributePrefix' => '_',
                 'attributes' => [],
                 'baseClasses' => [
...
B<OSCARS::Type::resDetails>  -  A class generated by L<XML::Pastor> . 
...
=item B<createTime>()      - See L<XML::Pastor::Builtin::long>.
...
=item B<login>()      - See L<XML::Pastor::Builtin::string>.

=item B<pathInfo>()      - See L<OSCARS::Type::pathInfo>.

=item B<startTime>()      - See L<XML::Pastor::Builtin::long>.

=item B<status>()      - See L<XML::Pastor::Builtin::string>.

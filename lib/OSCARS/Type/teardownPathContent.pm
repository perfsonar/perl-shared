...
package OSCARS::Type::teardownPathContent;


our @ISA=qw(XML::Pastor::ComplexType);

OSCARS::Type::teardownPathContent->mk_accessors( qw(token globalReservationId));

OSCARS::Type::teardownPathContent->XmlSchemaType( bless( {
                 'attributeInfo' => {},
                 'attributePrefix' => '_',
                 'attributes' => [],
                 'baseClasses' => [
...
B<OSCARS::Type::teardownPathContent>  -  A class generated by L<XML::Pastor> . 

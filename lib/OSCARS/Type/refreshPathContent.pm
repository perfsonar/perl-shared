...
package OSCARS::Type::refreshPathContent;


our @ISA=qw(XML::Pastor::ComplexType);

OSCARS::Type::refreshPathContent->mk_accessors( qw(token globalReservationId));

OSCARS::Type::refreshPathContent->XmlSchemaType( bless( {
                 'attributeInfo' => {},
                 'attributePrefix' => '_',
                 'attributes' => [],
                 'baseClasses' => [
...
B<OSCARS::Type::refreshPathContent>  -  A class generated by L<XML::Pastor> . 

...
use Log::Log4perl;
use_ok('perfSONAR_PS::Datatypes::v2_0::pinger::Message::Data::Datum');
...
#2
eval {
$obj1 = perfSONAR_PS::Datatypes::v2_0::pinger::Message::Data::Datum->new({
  ...
  ok( $obj1  && !$EVAL_ERROR , "Create object perfSONAR_PS::Datatypes::v2_0::pinger::Message::Data::Datum..." . $EVAL_ERROR);
  $EVAL_ERROR = undef; 
#3
...
#13
 my $obj22 = undef; 
 eval {
    $obj22   =   perfSONAR_PS::Datatypes::v2_0::pinger::Message::Data::Datum->new({xml => $string});
 };
...
#14
 ...
 my $obj2 = undef; 
 eval {
    $obj2   =   perfSONAR_PS::Datatypes::v2_0::pinger::Message::Data::Datum->new($dom1);
 };

...
use Log::Log4perl;
use_ok('perfSONAR_PS::Datatypes::v2_0::nmwg::Message::Data::Key');
...
#2
eval {
$obj1 = perfSONAR_PS::Datatypes::v2_0::nmwg::Message::Data::Key->new({
  'id' =>  'value_id',})
};
  ok( $obj1  && !$EVAL_ERROR , "Create object perfSONAR_PS::Datatypes::v2_0::nmwg::Message::Data::Key..." . $EVAL_ERROR);
  $EVAL_ERROR = undef; 
#3
...
#5
 ...
 eval {
      $obj_parameters  =  perfSONAR_PS::Datatypes::v2_0::nmwg::Message::Data::Key::Parameters->new({  'id' =>  'valueid',});
...
#7
 my $obj22 = undef; 
 eval {
    $obj22   =   perfSONAR_PS::Datatypes::v2_0::nmwg::Message::Data::Key->new({xml => $string});
 };
...
#8
 ...
 my $obj2 = undef; 
 eval {
    $obj2   =   perfSONAR_PS::Datatypes::v2_0::nmwg::Message::Data::Key->new($dom1);
 };

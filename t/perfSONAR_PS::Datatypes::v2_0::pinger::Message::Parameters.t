...
use Log::Log4perl;
use_ok('perfSONAR_PS::Datatypes::v2_0::pinger::Message::Parameters');
...
#2
eval {
$obj1 = perfSONAR_PS::Datatypes::v2_0::pinger::Message::Parameters->new({
  'id' =>  'value_id',})
};
  ok( $obj1  && !$EVAL_ERROR , "Create object perfSONAR_PS::Datatypes::v2_0::pinger::Message::Parameters..." . $EVAL_ERROR);
  $EVAL_ERROR = undef; 
#3
...
#5
 ...
 eval {
      $obj_parameter  =  perfSONAR_PS::Datatypes::v2_0::nmwg::Message::Parameters::Parameter->new({  'value' =>  'valuevalue',  'name' =>  'valuename',});
...
#7
 my $obj22 = undef; 
 eval {
    $obj22   =   perfSONAR_PS::Datatypes::v2_0::pinger::Message::Parameters->new({xml => $string});
 };
...
#8
 ...
 my $obj2 = undef; 
 eval {
    $obj2   =   perfSONAR_PS::Datatypes::v2_0::pinger::Message::Parameters->new($dom1);
 };

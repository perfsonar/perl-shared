...
print "\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n";
# use class
use_ok('perfSONAR_PS::MP::Agent::CommandLine');

# instantiate
my $cmd = '/bin/ping -c %count% %destination%';
my %options = ( 'count' => 5, 'destination' => 'localhost' );

my $agent = perfSONAR_PS::MP::Agent::CommandLine->new( $cmd, \%options );
ok( $agent->isa( 'perfSONAR_PS::MP::Agent::CommandLine'), 'Instantiation');

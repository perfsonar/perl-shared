...
LHC.cgi - List 'LHC' encoded hLS instances and check if they are responsive.

=head1 DESCRIPTION

Relies on a caching program (LHC.pl) to build up the list of instances that
match LHC related keywords in the gLS.  The cache program also determines
...
my $template = HTML::Template->new( filename => "etc/LHC.tmpl" );
my $CGI = CGI->new();
